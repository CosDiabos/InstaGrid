<script>
export default {
  name: 'IconDownloadAll',
  props: {w:{type:String,default:"6"}, h:{type:String,default:"6"}}
}
</script>
<template>
	<div :class="`w-${this.w} h-${this.h} inline-block`" title="Download all scheduled posts (.zip)">
